...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/29 13:54:02 by eakman            #+#    #+#             */
/*   Updated: 2024/05/03 16:29:33 by eakman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	free_contents(t_content **contents)
{
	int	i;
	...
	int is_append)
{
	...
	return (free_contents(cs), free(c), new_content);
}
